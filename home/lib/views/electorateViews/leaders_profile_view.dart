                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                                padding: EdgeInsets.fromLTRB(
                                                    12.0, 1.0, 12.0, 40.0),
                                                child: Text(
                                                    "Tasmania's gender ratio is almost even, with 49.5% male and 50.5% female.\n"
                                            ...
                                            Container(
                                                padding: EdgeInsets.fromLTRB(
                                                    12.0, 1.0, 12.0, 40.0),
                                                child: Text(
                                                    "An example of a chart to show the employment rate. Image found on Google.")),
                                            Container(
                                              child: Image(
                                                  image: AssetImage(
                                                      "assets/income.png")),
                                            ...
                                            Container(
                                                padding: EdgeInsets.fromLTRB(
                                                    12.0, 1.0, 12.0, 20.0),
                                                child: Text(
                                                    "An example of a chart to show the income of people. This is only a made up data.")),
                                          ])
                                    ]))))
                      ]),
                      Row(
